package com.dajung.response;

import com.dajung.common.exception.ErrorCode;
...
public class ErrorResponse {
	...
	public static ErrorResponse of(MethodArgumentTypeMismatchException exception) {
		...
		final List<ErrorResponse.FieldError> errors = ErrorResponse.FieldError.of(exception.getName(), value,
			exception.getErrorCode());
		return new ErrorResponse(GlobalErrorCode.INTERNAL_SERVER_EXCEPTION, errors);
	}
